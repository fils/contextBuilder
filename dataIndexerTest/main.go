...
func main() {
	...
	var domains []string
	domains = readWhiteList("whitelist_data.txt")
...
func bleveIndex(jsonld string) {
	...
	var record RWGDataSet // really need to use either of dataset or datacatlog depending on type.
	//  However, this code is not able to tell the difference between types..  the json-ld crawler should though...
